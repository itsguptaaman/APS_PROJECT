...
class TrainingPipelineConfig:
    ...
    def __init__(self):
        try:
            # Creating an artifact directory with current timestamp
...
class DataIngestionConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        try:
            ...
            # Creating an data_ingestion directory to store data
            self.data_ingestion_dir = os.path.join(
                training_pipeline_config.artifact_dir, "data_ingestion")

            # Creating an feature_store directory to features
            self.feature_store_file_path = os.path.join(
                self.data_ingestion_dir, "feature_store", FILE_NAME)

            # Creating an dataset directory to train data
            self.train_file_path = os.path.join(
                self.data_ingestion_dir, "dataset", TRAIN_FILE_NAME)

            # Creating an dataset directory to test data
...
class DataTransformationConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.transformed_train_path = os.path.join(
            self.data_transformation_dir, "transformed", TRAIN_FILE_NAME)

        self.transformed_test_path = os.path.join(
            self.data_transformation_dir, "transformed", TEST_FILE_NAME)
