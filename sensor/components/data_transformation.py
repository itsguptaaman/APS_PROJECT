...
class DataTransformation:
    ...
    # Class method is used to change the values of the class
    @classmethod
    def get_data_transformer_object(cls) -> Pipeline:
        try:
            # We can use strategy as mean and median also
    ...
    def initiate_data_transformation(self,) -> artifact_entity.DataTransformationArtifact:
        try:
            # reading training and testing file as a dataframe
            ...
            # target encoder
            # np.c_ is used to concat two arrays
